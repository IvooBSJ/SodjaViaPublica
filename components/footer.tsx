        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              <Image src="/images/logo.png" alt="Sodja Via Publica" width={40} height={40} className="mr-2" />
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#trabajos" className="text-gray-400 hover:text-white transition-colors">
                  Trabajos
                </a>
              </li>
              <li>
