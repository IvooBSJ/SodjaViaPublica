...
export default function Home() {
  ...
  const botonTelefono = (e: React.KeyboardEvent<HTMLInputElement>) => {
    ...
    const isAllowedKey = /[0-9+]/.test(e.key) || ["Backspace", "ArrowLeft", "ArrowRight", "Delete"].includes(e.key)
  ...
  const services = [
    ...
    {
      title: "Primer Piso",
      description: "Tu marca en puntos de alto impacto visual",
      image: "/images/primerospisos.jpg",
      features: ["Amplia cobertura", "Diferentes formatos", "Altura de publicidad"],
    },
    {
  ...
  const featuredProjects = [
    {
      title: "Campaña Promocion Naranja X",
      client: "Naranja X",
      image: "/images/campañas/naranjax.jpg",
    },
    {
      title: "Campaña Promocion Fanta",
      client: "Empresa de Bebidas",
      image: "/images/campañas/fanta.jpg",
    },
    {
      title: "Publicidad Canal 9",
      client: "Canal 9",
      image: "/images/campañas/canalnueve.jpg",
    },
  ]
  ...
  const additionalProjects = [
    {
      title: "Campaña de Claro Vigilancia",
      client: "Empresa de Servicios de Vigilancia",
      image: "/images/campañas/serviciosvigilancia.jpg",
    },
    {
      title: "Campaña Rapicuotas",
      client: "Rapicuotas",
      image: "/images/campañas/rapicuotas.jpg",
    },
    {
      title: "Invasion del Amor de Dios",
      client: "Iglesia Evangelista",
      image: "/images/campañas/invasiondelamor.jpg",
    },
    {
      title: "Nueva Obra de Teatro",
      client: "Obra de Teatro",
      image: "/images/campañas/obradeteatro.jpg",
    },
    {
      title: "Cementos Avellaneda",
      client: "Ginesta Hnos",
      image: "/images/campañas/cementosavellaneda.jpg",
    },
    {
      title: "Publicidad Gobierno del Chaco",
      client: "Gobierno del Chaco",
      image: "/images/campañas/gobiernochaco.jpg",
    },
  ]

  // Empresas destacadas iniciales
  {/*  const featuredCompanies = [
    {
      name: "Hamilton",
      logo: "/images/hamiltonlogo.jpeg",
    },
    {
      name: "McDonald's",
      logo: "/images/mcdonaldslogo.png",
    },
    {
      name: "Miller",
    ...
    {
      name: "Yamaha",
      logo: "/images/yamahalogo.png",
    },
    {
      name: "Tersuave",
      logo: "/images/Logo_Tersuave.jpg",
    },
    {
      name: "Credil",
      logo: "/images/credillogo.jpeg",
    },
  ]
*/}
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="fixed w-full bg-white shadow-md z-50">
        <div className="container mx-auto px-4 py-3">
          <div className="flex justify-between items-center">
            {/* Actualizar la referencia al logo en el header */}
            <div className="flex items-center mr-8">
              <Image src="/images/logo.png" alt="Sodja Via Publica Logo" width={50} height={50} className="mr-2" />
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <a href="#trabajos" className="text-gray-800 hover:text-red-600 transition-colors">
                Trabajos
              </a>
      ...
      <section id="inicio" className="pt-24 md:pt-0 relative h-screen">
            ...
            <div className="max-w-3xl">
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <a href="#contacto">
                  <Button
                    size="lg"
                    className="bg-white text-black hover:bg-gray-100 w-full sm:w-auto border-2 border-white"
                  >
                    Contactanos
                  </Button>
                </a>
        ...
        {/* Slider Navigation */}
        <div className="absolute bottom-4 md:bottom-8 left-0 right-0 flex justify-center space-x-2">
          {slides.map((_, index) => (
            <button
              key={index}
      ...
      <section id="proyectos" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">Conoce algunos de nuestros trabajos más exitosos.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredProjects.map((project, index) => (
              <div key={index} className="group relative overflow-hidden rounded-lg shadow-md h-80">
                <Image
      ...
      <section id="proyectos" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Algunas de las empresas que han elegido nuestros servicios para destacar su marca.
            </p>
          </div>
      ...
      <section id="ubicaciones" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Contamos con una fabrica y una oficina comercial, donde atendemos si se pone en contacto con nosotros para
              coordinar una cita.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <a href="https://maps.app.goo.gl/edsMTDii3MnRUsPs7" target="_blank" rel="noopener noreferrer">
                  <Button variant="link" className="text-red-600 p-0">
                    Ver ubicación <ArrowRight className="ml-1 h-4 w-4" />
                  </Button>
                </a>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onKeyDown={botonTelefono}
                      placeholder="XXX XXX XXXX"
                      className={`w-full rounded-md border ${
                        formData.phone && !/^\+?[0-9]+$/.test(formData.phone) ? "border-red-500" : "border-gray-300"
                      } p-2 focus:outline-none focus:ring-2 focus:ring-red-600`}
                    />
                    {formData.phone && !/^\+?[0-9]+$/.test(formData.phone) && (
                      <p className="mt-1 text-sm text-red-600">Solo se permiten números y el símbolo + al inicio!</p>
                    )}
                  </div>
                </div>
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a
                    href="https://www.facebook.com/people/SODJA-Via-Publica/100063490182954/"
                  ...
                  <a
                    href="https://www.instagram.com/sodjaviapublica/"
                    className="bg-red-600 text-white p-3 rounded-full hover:bg-red-700 transition-colors"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path
